...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.3.0/git-cola-4.3.0.windows.zip'
  checksum     = 'ebfa13de172e50c74c9a11f2adf021b6a89382f3467fb3639ee52bffca44cad5'
  checksumType = 'sha256'
}
