...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v3.6/git-cola-3.6.windows.zip'
  checksum     = '7564f4975f1964315231435721ca8384360c5c780c9e7576ba7a7b6e2a590c98'
  checksumType = 'sha256'
}
