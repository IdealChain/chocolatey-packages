...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v3.4/git-cola-3.4.windows.zip'
  checksum     = '603901f94b020eae8c17790f12291cfc1ae3fde06cce699ac3e43915f3fde090'
  checksumType = 'sha256'
}
