...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v3.3/git-cola-3.3.windows.zip'
  checksum     = '3bb4e1cdfd01033b47b7fb691e0f4074fbc928366068cd7d6b77ee6e286ddfb6'
  checksumType = 'sha256'
}
