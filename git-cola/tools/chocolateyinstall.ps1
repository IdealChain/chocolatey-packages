...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.17.0/git-cola-4.17.0.windows.zip'
  checksum     = '8e4488867953308c2bf919b77763fa0cfcc7b20149a48bb2ec8f9f72db428b58'
  checksumType = 'sha256'
}
