...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v3.11.0/git-cola-3.11.0.windows.zip'
  checksum     = 'df36954c2d6fbb3cd99cfd569e7ae7901195baa097a1eb3d1eacadf86353ee7b'
  checksumType = 'sha256'
}
