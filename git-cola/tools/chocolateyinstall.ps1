...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.6.1/git-cola-4.6.1.windows.zip'
  checksum     = 'c05a988d388b8906a5edaadeffefa70c8f820cc39f20b0b58b413e5e54b09825'
  checksumType = 'sha256'
}
