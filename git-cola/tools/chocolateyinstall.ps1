...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.3.2/git-cola-4.3.2.windows.zip'
  checksum     = '65ea0af43198de509fcda6f117c9cc258be41e06b854f73c1d93314235665bc5'
  checksumType = 'sha256'
}
