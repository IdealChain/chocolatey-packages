...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.16.1/git-cola-4.16.1.windows.zip'
  checksum     = '82ec929bc0e02f4be4aeba75e8610f1b382cb865f1652a436c6bde963a9cb208'
  checksumType = 'sha256'
}
