...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.18.1/git-cola-4.18.1.windows.zip'
  checksum     = 'b4a62ba051bfc861f2dda7f43c81b4e10517e881dddc894146fa9e2eed6a343e'
  checksumType = 'sha256'
}
