...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v3.7/git-cola-3.7.windows.zip'
  checksum     = 'a32a31212c5116812a11754805c5516746ae256f7814bceae22f53051b14ff45'
  checksumType = 'sha256'
}
