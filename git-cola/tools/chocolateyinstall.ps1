...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.0.4/git-cola-4.0.4.windows.zip'
  checksum     = '7d7253b5b59dddb8a9df0beff42ed157d7ebf3ba9a4d6e2a823826ca5bb29a05'
  checksumType = 'sha256'
}
