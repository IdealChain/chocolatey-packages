...
$packageArgs = @{
  ...
  url          = 'https://github.com/git-cola/git-cola/releases/download/v4.14.0/git-cola-4.14.0.windows.zip'
  checksum     = '73474248d6bd03262016d0e145f9257a9b2f21558e311fcaff479eb95a0d94a4'
  checksumType = 'sha256'
}
