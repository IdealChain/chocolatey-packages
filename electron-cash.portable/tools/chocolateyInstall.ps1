...
$packageArgs = @{
    ...
    url            = 'https://electroncash.org/downloads/4.2.13/win-linux/Electron-Cash-4.2.13.exe'
    checksum       = 'c87c331cc424c54d658dc1091bb9a0268599c5c14577dab921afc653a4f9e65f'
    checksumType   = 'sha256'
    forceDownload  = $true
}
