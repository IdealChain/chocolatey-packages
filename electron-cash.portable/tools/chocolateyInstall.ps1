...
$packageArgs = @{
    ...
    url            = 'https://electroncash.org/downloads/4.0.15/win-linux/Electron-Cash-4.0.15.exe'
    checksum       = 'a6c006acf66fc6c86c4327fdbadfaa374119abb6697007cb32636eb23b55e4ae'
    checksumType   = 'sha256'
    forceDownload  = $true
}
