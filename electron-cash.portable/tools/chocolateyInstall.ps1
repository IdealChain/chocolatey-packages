...
$packageArgs = @{
    ...
    url            = 'https://electroncash.org/downloads/4.0.13/win-linux/Electron-Cash-4.0.13.exe'
    checksum       = '9b110b2f324089c4ce7d7a8cf142dcf883f7b1a078ae46f0bbb33835fe9d887f'
    checksumType   = 'sha256'
    forceDownload  = $true
}
